  ...
  return (
    ...
    >
      <style>{`
        ...
        .login-hero { animation: slideInLeft 0.8s ease-out; }
        .login-form { animation: slideInRight 0.8s ease-out; }
        .floating-element { animation: float 3s ease-in-out infinite; }

        @media (max-width: 1024px) {
          .login-hero { display: none !important; }
          .login-form { gridColumn: 1 / -1; }
        }
      `}</style>
        ...
        >
          ...
          <div style={{ position: "relative", zIndex: 10, textAlign: "center", color: "white", maxWidth: "350px" }}>
            ...
            <div style={{ display: "grid", gap: "1.2rem" }}>
              {[
                { icon: "🎮", title: "Fun Quizzes", desc: "Thousands of engaging quizzes" },
                { icon: "📰", title: "Trending News", desc: "Stay updated with latest" },
                { icon: "👥", title: "Community", desc: "Connect with millions" },
              ].map((item, i) => (
                <div
                  key={i}
                  style={{
