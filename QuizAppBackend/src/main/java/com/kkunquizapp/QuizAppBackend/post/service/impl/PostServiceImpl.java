package com.kkunquizapp.QuizAppBackend.post.service.impl;

import com.kkunquizapp.QuizAppBackend.chat.repository.ReactionRepo;
...
import com.kkunquizapp.QuizAppBackend.fileUpload.repository.PostMediaRepo;
    ...
    public void likePost(UUID userId, UUID postId, ReactionType type) {
        ...
        if (reactionRepository.existsByUserAndTargetIdAndTargetType(user, postId, ReactionTargetType.POST)) {
            ...
            notificationService.createNotification(
                    ...
                    "POST",
                    postId,
                    com.kkunquizapp.QuizAppBackend.common.utils.StringUtils.abbreviate(post.getContent(), 60)
            );
