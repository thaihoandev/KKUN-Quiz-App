...
import com.kkunquizapp.QuizAppBackend.common.interceptor.AuthorizationInterceptor;
import com.kkunquizapp.QuizAppBackend.common.interceptor.JwtInterceptor;
import com.kkunquizapp.QuizAppBackend.common.interceptor.QuizPermissionInterceptor;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(jwtInterceptor)
                .addPathPatterns("/api/users/**", "/api/quizzes/**","/api/articles/**")
